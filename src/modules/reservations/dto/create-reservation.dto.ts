import { IsNotEmpty, IsOptional, IsString, IsNumber, IsEnum, IsDateString, IsUUID } from 'class-validator';
...
export class CreateReservationDto {
    ...
    @ApiPropertyOptional({ enum: ReservationMethod, default: ReservationMethod.EMAIL })
    @IsOptional()
